...
/*:
 ...
 Forests help clean our water, filter our air, and also provide food, medicine, and fuel when needed!
 
 # 🌳 🌳 🌳
 
 ## Instructions
 
 1. Enter coordinates of the trees to be planted using the `addTree` method below
 2. Tap "Run My Code" to begin planting
 */
